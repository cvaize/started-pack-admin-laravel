...
class StartedPackAdminLaravelServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__.'/Vendor/app/Http/Controllers/Auth' => base_path('app/Http/Controllers/Auth'),
            __DIR__.'/Vendor/app/Http/Controllers/Users' => base_path('app/Http/Controllers/Users'),
            __DIR__.'/Vendor/app/Models/Users' => base_path('app/Models/Users'),
            __DIR__.'/Vendor/app/Providers/ConfigServiceProvider.php' => base_path('app/Providers/ConfigServiceProvider.php'),
            __DIR__.'/Vendor/app/Providers/FakerServiceProvider.php' => base_path('app/Providers/FakerServiceProvider.php'),
            __DIR__.'/Vendor/config/laravel-translation-manager.php' => base_path('config/laravel-translation-manager.php'),
            __DIR__.'/Vendor/config/laravellocalization.php' => base_path('config/laravellocalization.php'),
